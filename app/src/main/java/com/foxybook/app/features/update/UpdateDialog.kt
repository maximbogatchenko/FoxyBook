    ...
    when (val currentState = state) {
        is UpdateDialogState.Available -> {
            AlertDialog(
                ...
                text = {
                    Column {
                        Text(stringResource(R.string.update_version_available, currentState.info.version))
                    ...
                    Button(onClick = {
                        scope.launch {
                            ...
                            try {
                                ...
                                state = UpdateDialogState.Error(e.message ?: context.getString(R.string.settings_download_error))
                            }
                        }
        ...
        is UpdateDialogState.Downloaded -> {
            AlertDialog(
                ...
                title = { Text(stringResource(R.string.settings_update_downloaded), fontWeight = FontWeight.Bold) },
                text = { Text(stringResource(R.string.update_downloaded_install_hint)) },
                confirmButton = {
                    Button(onClick = {
        ...
        is UpdateDialogState.Error -> {
            AlertDialog(
                ...
                title = { Text(stringResource(R.string.reader_error), fontWeight = FontWeight.Bold) },
